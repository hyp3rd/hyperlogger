...
const appLoggerBufferSize = 1024

// New creates a new logger instance with the specified environment and service.
...
func New(ctx context.Context, environment string, service string) (logger.Logger, error) {
